...
Version `1.0.12` is the current patch release after the first local-mode release. Local mode has been tested by the maintainer and works for real Impress control in the current development environment.
