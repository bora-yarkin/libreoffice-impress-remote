...
Version `0.7.7` is a usable pre-1.0 build. Local mode has been tested by the maintainer and works for real Impress control in the current development environment.
