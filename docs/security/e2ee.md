...
Current local, LocalTunnel, direct IPv6, and relay profile in `1.0.11`:
...
For `1.0.11`, the supported relay trust model is:

- self-host the published Python relay bundle or a compatible relay implementation
